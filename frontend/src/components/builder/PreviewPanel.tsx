        ...
        <div className="flex-1 overflow-auto relative">
            ...
            {isGenerating && (
                <div className="absolute bottom-4 left-1/2 -translate-x-1/2 z-10">
                    <div className="flex items-center gap-3 rounded-[8px] border border-white/[0.08] bg-[#1a1c1c]/95 px-5 py-2.5 text-white/60 shadow-xl shadow-black/40 backdrop-blur-sm">
